...
data_root = 'data/cloudsen12_high_l2a'
dataset_type = 'CLOUDSEN12HIGHL2ADataset'
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False,
        interval=4000,
...
launcher = 'none'
load_from = 'checkpoints/cloud-adapter/l2a_full_weight.bin'
log_level = 'INFO'
...
work_dir = './work_dirs/cloud_adapter_pmaa_convnext_lora_16_adapter_all_l2a_test'
