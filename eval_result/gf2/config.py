...
launcher = 'none'
load_from = 'checkpoints/cloud-adapter/gf2_full_weight.bin'
log_level = 'INFO'
...
work_dir = './work_dirs/cloud_adapter_pmaa_convnext_lora_16_adapter_all_gf2_test'
