...
launcher = 'none'
load_from = 'work_dirs/ours_adapter_pmaa_convnext_lora_16_adapter_all_l8_load_head_40w/l8_full_weight.pth'
log_level = 'INFO'
...
work_dir = './work_dirs/cloud_adapter_pmaa_convnext_lora_16_adapter_all_l8_load_head_40w_test'
